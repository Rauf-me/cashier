...
public class BarangService {
    ...
    private void readFile() {
        ...
        List<String> strList = bufferedReader.lines().collect(Collectors.toList());
    ...
    public List<Barang> findByName(String name) {
        return bList.stream().filter(barang -> barang.getNama().startsWith(name)).collect(Collectors.toList());
    }
}